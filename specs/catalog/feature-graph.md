...
- **`related:` is hand-written and preserved across regeneration**, as are a doc's type and tags once it has them — the classifier only sets those on a doc that lacks them.
