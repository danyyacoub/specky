...
Guidance for agents in this repo — Claude Code, opencode, Kiro and Devin all read this file, so
everything a coding agent needs lives here rather than in a tool-specific copy.
